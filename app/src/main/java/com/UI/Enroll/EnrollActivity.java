...
import com.example.handsets.MainActivity;
...
public class EnrollActivity extends AppCompatActivity {
		...
		btn_enrol.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				if(fpm.GenerateTemplate(2)){
					...
					Toast.makeText(EnrollActivity.this, "Busy", Toast.LENGTH_SHORT).show();
				}
			}
		});
    ...
    private void showDialog(){
        ...
        dialog.setContentView(R.layout.enroll_fingerprint_layout);
        dialog.show();
    }
}